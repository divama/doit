<template>
	<ion-item v-if="message" :routerLink="'/message/' + message.id" :detail="false" class="list-item">
		...
		<ion-label class="ion-text-wrap">
			...
			<ion-note> Lorem ipsum dolor sit amet 
...
<script lang="ts">
import { IonIcon, IonItem, IonLabel, IonNote, IonCheckbox, IonBadge } from '@ionic/vue';
import { chevronForward, logoApple, logoAndroid } from 'ionicons/icons';
...
export default defineComponent({
	...
	data() {
		return { chevronForward, logoApple, logoAndroid }
	}
});
</script>
